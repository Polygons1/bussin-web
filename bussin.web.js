...
var NewElement_default = Element;

// app.jsx
var import_react = __toESM(require_react(), 1);

// bussin/frontend/lexer.ts
...
// bussin/runtime/eval/expressions.ts
...
// bussin/runtime/eval/statements.ts
...
// bussin/index.ts
async function send(expression) {
...
var App = function() {
  ...
  const [input, setInput] = import_react.useState(false);
...
var app_default = jsx_dev_runtime.jsxDEV(App, {}, undefined, false, undefined, this);

// index.js
client.default.createRoot(NewElement_default()).render(app_default);
